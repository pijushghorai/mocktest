...
if($submit=='Add' || strlen($subname)>0 )
{
	$tr="select * from mst_subject where sub_name='$subname'";
$rs=mysqli_query($con,$tr);
if (mysqli_num_rows($rs)>0)
{
	echo "<br><br><br><div class=head1>Subject is Already Exists</div>";
	exit;
}
	$ty="insert into mst_subject(sub_name) values ('$subname')";
mysqli_query($con,$ty) or die(mysql_error());
