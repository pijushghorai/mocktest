...
$totque=$_POST['totque'];
/*}
if($_POST['submit']=='Add' || strlen($_POST['subid'])>0 )
{*/
if(strlen($_POST['subid'])>0)
{
extract($_POST);
mysqli_query($con,"insert into mst_test(sub_id,test_name,total_que) values ('$subid','$testname','$totque')") or die(mysqli_error());
