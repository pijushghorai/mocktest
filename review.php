...
if($submit=='Finish')
{
	$qe="delete from mst_useranswer where sess_id='" . session_id() ."'";
	mysqli_query($con,$qe) or die(mysql_error());
	unset($_SESSION[qn]);
...
else if($submit=='Next_Question' )
{
	$_SESSION['qn']=$_SESSION['qn']+1;
	
}

	$qw="select * from mst_useranswer where sess_id='" . session_id() ."'";
$rs=mysqli_query($con,$qw) or die(mysql_error());
