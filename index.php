...
<html>
<head>
<title>Wel come to Online JECA Mock Test </title>
...
if(isset($submit))
{
	$fp="select * from mst_user where login='$loginid' and pass='$pass'";
	$rs=mysqli_query($con,$fp);
...
<table width="100%" border="0">
  ...
  <tr>
    <td height="296" valign="top"><div align="center">
        <h1 class="style8">Welcome to Online JECA Mock Test </h1>
...
<p align="left" class="style5">&nbsp;</p>
      <blockquote>
          <p align="center" class="style5"><span class="style7">Welcome to Online 
            exam. This Site will provide the quiz for various subject of interest. </span><span class="style7"><br>You need to login for the take the online exam.<br>
          </span></p>
          <p align="center" class="style5"><span class="style7">Developed by Pijush Ghorai</span></p>
      </blockquote>
    </div></td>
    <td valign="top"><form name="form1" method="post" action="">
      ...
      <div align="center">
        <p class="style5"><img src="images/software.png" width="200" height="200">          </p>
        </div>
    </form></td>
  </tr>
</table>
